"""MNase-seq mode: bowtie2 → samtools → fragment-size filter → bamCoverage (3 tracks).
...
from tinymapper._common import align_bowtie2_paired, bam_coverage_cpm, filter_bam_paired
...
def run(
    ...
    """Execute the MNase-seq pipeline."""
